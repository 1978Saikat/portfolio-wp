...
<footer id="footer">
  ...
  <script src="<?php bloginfo('template_url'); ?>/assets/vendor/typed.js/typed.min.js"></script>
  <script src="<?php bloginfo('template_url'); ?>/assets/vendor/waypoints/noframework.waypoints.js"></script>
